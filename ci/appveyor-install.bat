...
@REM Modified time: 2018-03-21 14:48:27
...
START /B CMD /C "pip install --upgrade pip & pip install pipenv"
START /B CMD /C "choco install nodejs -y & npm install -g grunt-cli"
